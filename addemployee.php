...
?>
    ...
    <style>
        body {
            background: url("img/new/home/image5.jpg");
...
<header id="header">
    <div class="container-fluid">
        ...
        <div id="logo" class="pull-left">
            <h5><a href="#intro" class="scrollto">New Employee Registration</a></h5>
        </div>
        ...
        <div class="box">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3"><input type="text" class="form-control" id="fname"
                                                 placeholder="Enter first name" name="fname" pattern=[A-Za-z]{2,30}
                                                 title="Only alphabet" onblur="checkFName()" required></div>
                    <div class="col-md-2 text-right"><label
                                for="lname">&nbsp;&nbsp;Last&nbsp;Name<span>&#42;</span></label></div>
                    <div class="col-md-3"><input type="text" class="form-control" id="lname"
                                                 placeholder="Enter last name" name="lname" pattern=[A-Za-z]{2,30}
                                                 title="Only alphabet" onblur="checkLName()" required></div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control has-success" id="uname" placeholder="Enter username"
                               name="uname" onblur="checkUName()" onkeyup="checkUserName()" required></div>
                    <div class="col-md-2 text-right"><label for="photo">&nbsp;&nbsp;Photo</label></div>
                    <div class="col-md-3"><input type="file" class="form-control" id="photo" name="photo"
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-5"><input type="text" class="form-control" id="mobile"
                                                 placeholder="Enter mobile number" name="mobile"
                                                 onkeypress="return( event.charCode >47 && event.charCode < 58)"
                                                 maxlength="10" minlength="10" required></div>
                    <div class="col-md-2 text-right"><label
                                for="dob">&nbsp;&nbsp;Date&nbsp;of&nbsp;Birth<span>&#42;</span></label></div>
                    <div class="col-md-3"><input type="date" class="form-control" id="dob" name="dob"
                                                 onblur="checkDOB()" required/></div>
                </div>
                <div class="row">
                    <div class="col-md-1"></div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-5"><input type="email" class="form-control" id="email"
                                                 placeholder="Enter email address" name="email" onblur="checkEmail()"
                                                 required></div>
                    <div class="col-md-1"></div>
                    <div class="col-md-1"><label for="nationality">Nationality</label></div>
                    <div class="col-md-2">
                        <input list="country_list" name="nationality" id="nationality" class="form-control"
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <textarea class="form-control" id="p_address" name="p_address" row="4"
                                  placeholder="Enter permanent address"></textarea></div>
                    <div class="col-md-1"></div>
                    <div class="col-md-5">
                        <table id="gender">
                            <tr>
                                <th style="padding-top:10px;"><label>&nbsp;&nbsp;Gender&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                </th>
                                <td><label class="radio radio-inline"><input type="radio" name="gender" value="male"
                                                                             checked/>Male&nbsp;&nbsp;</label></td>
                                <td><label class="radio radio-inline"><input type="radio" name="gender" value="female"/>Female</label>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div class="box">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3"><input type="text" class="form-control" id="empid" name="empid"
                                                 value="EMP####" readonly="readonly"/></div>
                    <div class="col-md-3"></div>
                    <div class="col-md-2 text-right"><label
                                for="doj">Date&nbsp;of&nbsp;Joining<span>&#42;</span></label></div>
                    <div class="col-md-2"><input type="date" class="form-control" id="doj" name="doj"
                                                 onblur="checkDOJ()" style="width: 180px" required/></div>
                </div>
                <div class="row">
        ...
        <div class="box">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-2"><input type="text" class="form-control" id="basic" name="basic"
                                                 onblur="checkBasic()" required/></div>
                    <div class="col-md-1"></div>
                    <div class="col-md-1 text-right"><label for="hra">HRA</label></div>
                    <div class="col-md-2"><input type="text" class="form-control" id="hra" name="hra"
                                                 onblur="checkHRA()"/></div>
                    <div class="col-md-2 text-right"><label for="conveyance">Conveyance</label></div>
                    <div class="col-md-2"><input type="text" class="form-control" id="conveyance" name="conveyance"
                                                 onblur="checkConveyance()"/></div>
                </div>
                <div class="row">
                    <div class="col-md-2"></div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-2"><input type="text" class="form-control" id="medical" name="medical"
                                                 onblur="checkMedical()"/></div>
                    <div class="col-md-2 text-right"><label for="specialAllowance">Special&nbsp;Allowance&nbsp;</label>
                    </div>
                    <div class="col-md-2"><input type="text" class="form-control" id="special" name="special"
                                                 onblur="checkSpecial()"/></div>
                    <div class="col-md-2 text-right"><label for="providentfund">Provident&nbsp;Fund&nbsp;</label></div>
                    <div class="col-md-2"><input type="text" class="form-control" id="provident" name="provident"
                                                 onblur="checkProvident()"/></div>
                </div>
                <div class="row">
                    <div class="col-md-2"></div>
        ...
        <div class="box">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6"><input type="text" class="form-control" placeholder="Enter Bank Name"
                                                 id="bankname" name="bankname" onblur="checkBankName()" required/></div>
                </div>
                <div class="row">
                    <div class="col-md-2"></div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4"><input type="text" class="form-control" placeholder="Enter Account Number"
                                                 id="account" name="account" onblur="checkAccount()" required/></div>
                    <div class="col-md-1"></div>
                    <div class="col-md-1 text-right"><label for="pan">PAN&nbsp;</label></div>
                    <div class="col-md-4"><input type="text" class="form-control" placeholder="Enter PAN" id="pan"
                                                 name="pan" onblur="checkPAN()" required/></div>
                </div>
                <div class="row">
                    <div class="col-md-2"></div>
...
if (isset($_POST['submit'])) {
    ...
    $conn = mysqli_connect("localhost", "root", "19960913", "project") or die($conn);
