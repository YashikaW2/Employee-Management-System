...
<head>
    ...
    <style>
        ...
        #back {
            background-image: url("img/new/home/image1.jpg");
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-2.5">
            ...
            <div class="box-sm text-center"><label>Password&nbsp;:&nbsp;</label><span
                        id="password"><?php echo $password ?></span></div>
            <div>
...
<div class="container-fluid row">
    <div class="col-md-5 box" style="margin-left:80px;">
        ...
        <table class="table box-sm">
            <tr>
                ...
                <td><span id="uname"><?php echo $uname ?></span></td>
            </tr>
            <tr>
                <td><label>Date of Birth</label></td>
                <td><span id="dob"><?php echo $dob ?></span></td>
            </tr>
            <tr>
                <td><label>Age</label></td>
                <td><span id="age"><?php $diff = date_diff(date_create($dob), date_create(date("Y-m-d")));
                        echo $diff->format("%y years"); ?></span></td>
            </tr>
            <tr>
                <td><label>Gender</label></td>
                <td><span id="gender"><?php echo $gender ?></span></td>
            </tr>
            <tr>
                <td><label>Mobile</label></td>
                <td><span id="mobile"><?php echo $mobile ?></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><span id="f_name"><?php echo $f_name ?></span></td>
            </tr>
            <tr>
                <td><label>Marital Status</label></td>
                <td><span id="m_status"><?php echo $m_status ?></span></td>
            </tr>
            <tr>
                <td><label>Spouse Name</label></td>
                <td><span id="s_name"><?php echo $s_name ?></span></td>
            </tr>
            <tr>
                <td><label>Nationality</label></td>
                <td><span id="nationality"><?php echo $nationality ?></span></td>
            </tr>
        </table>
    </div>
    ...
    <div class="col-md-5 box" style="margin-left:80px;margin-bottom:40px;">
        ...
        <table class="table box-sm">
            <tr>
                <td colspan="2"><h4>Master Degree Details</h4></td>
            </tr>
            <tr>
                <td><label>Degree</label></td>
                <td><span id="m_degree"><?php echo $m_degree ?></span></td>
            </tr>
            <tr>
                <td><label>Institute</label></td>
                <td><span id="m_institute"><?php echo $m_institute ?></span></td>
            </tr>
            <tr>
                <td><label>Passing year</label></td>
                <td><span id="m_year"><?php echo $m_year ?></span></td>
            </tr>
            <tr>
                <td><label>CGPA/Percentage</label></td>
                <td><span id="m_cgpa"><?php echo $m_cgpa ?></span></td>
            </tr>
        </table>
        <table class="table box-sm" style="margin-bottom:0px;">
            <tr>
                <td colspan="2"><h4>Bachelor Degree Details</h4></td>
            </tr>
            <tr>
                <td><label>Degree</label></td>
                <td><span id="b_degree"><?php echo $b_degree ?></span></td>
            </tr>
            <tr>
                <td><label>Institute</label></td>
                <td><span id="b_institute"><?php echo $b_institute ?></span></td>
            </tr>
            <tr>
                <td><label>Passing year</label></td>
                <td><span id="b_year"><?php echo $b_year ?></span></td>
            </tr>
            <tr>
                <td><label>CGPA/Percentage</label></td>
                <td><span id="b_cgpa"><?php echo $b_cgpa ?></span></td>
            </tr>
        </table>
    ...
    <div class="col-md-3 box" style="margin-left:80px;margin-bottom:40px;">
        ...
        <table class="table box-sm">
            <tr>
                ...
                <td><span id="type"><?php echo $type ?></span></td>
            </tr>
            <tr>
                <td><label>Joined On</label></td>
                <td><span id="doj"><?php echo $doj ?></span></td>
            </tr>
        </table>
    </div>
    ...
    <div class="col-md-7 box" style="margin-left:80px;margin-bottom:40px;">
        ...
        <table class="table box-sm">
            <tr>
                ...
                <td><span id="basic"><?php echo $basic ?></span></td>
                <td><label>HRA</label></td>
                <td><span id="hra"><?php echo $hra ?></span></td>
                <td><label>Conveyance</label></td>
                <td><span id="conveyance"><?php echo $conveyance ?></span></td>
            </tr>
            <tr>
                <td><label>Medical Allowance</label></td>
                <td><span id="medical"><?php echo $medical ?></span></td>
                <td><label>Special Allowance</label></td>
                <td><span id="special"><?php echo $special ?></span></td>
                <td><label>Provident Fund</label></td>
                <td><span id="provident"><?php echo $provident ?></span></td>
            </tr>
        </table>
    ...
    <div class="col-md-3 box" style="margin-left:80px;margin-bottom:40px;">
        ...
        <table class="table box-sm">
            <tr>
                ...
                <td><span id="bankname"><?php echo $bankname ?></span></td>
            </tr>
            <tr>
                <td><label>Account No.</label></td>
                <td><span id="account"><?php echo $account ?></span></td>
            </tr>
            <tr>
                <td><label>PAN</label></td>
                <td><span id="pan"><?php echo $pan ?></span></td>
            </tr>
        </table>
    </div>
    ...
    <div class="col-md-7 box" style="margin-left:80px;margin-bottom:40px;">
        ...
        <table class="table box-sm">
            <tr>
                ...
                <td><span id="c_address"><?php echo $c_address ?></span></td>
            <tr>
                <td><label>Permanent Address</label></td>
                <td><span id="p_address"><?php echo $p_address ?></span></td>
        </table>
