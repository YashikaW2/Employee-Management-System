...
<head>
    ...
    <link href="img/new/logo.png" rel="apple-touch-icon">
...
<div class="container box info">
    <div class="row">
        ...
        <div class="col-md-6 box nameplate">
            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="button" class="btn btn-primary btn-sm" onClick="show_pic_box()">Change Photo</button>
                    ...
                    <div id="chg_pic" style="display:none;">
                        <form action="update_profile.php" method="POST" id="chg_pic_form" enctype="multipart/form-data">
                            <div class="row form-group">
                                <div class="col-md-10"><input type="file" class="form-control" name="photo" id="photo">
                                </div>
                            </div>

                            <div class="row form-group">
                                <div class="col-md-10">
                                    <button type="submit" class="btn btn-sm btn-success" name="save_pic">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="col-md-3 box-sm">
            <div class="row">
                <div class="col-md-10 form-group">
                    <button type="button" name="chg_pwd" class="btn btn-warning" onclick="show_chg_pwd()">Change&nbsp;Password</button>
                </div>
            </div>
            <div id="chg_pwd" style="display:none;">
                <form action="#" method="post" id="chg_pwd_form">
                    <div class="row form-group">
                        <div class="col-md-10"><input type="text" name="c_pass" class="form-control"
                                                      placeholder="Enter Your Current Password" style="color:white"/>
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-10"><input type="text" name="n_pass" class="form-control"
                                                      placeholder="Enter Your New Password" style="color:white"/></div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-10"><input type="text" name="r_pass" class="form-control"
                                                      placeholder="Reenter Your New Password" style="color:white"/>
                        </div>
                    </div>

                    <div class="row form-group">
                        <div class="col-md-10">
                            <button type="submit" class="btn btn-sm btn-success" name="save_pwd">Save</button>
                        </div>
                    </div>
                </form>
            ...
            <div>
                <button type="button" class="btn btn-primary" onClick="window.print();"><span
                            class="glyphicon glyphicon-print"></span> Print Details
                </button>
            </div>
            <br><br><br><br><br><br><br><br><br><br><br><br>
        </div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-2">
            <button type="button" class="btn btn-info btn-block" data-toggle="collapse" data-target="#personal">Personal
                Information
            </button>
        </div>
        ...
        <div class="col-md-9 collapse box" id="personal">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <button type="button" class="btn" name="edit_personal" data-toggle="modal"
                            data-target="#edit_personal"><img src="img/edit_sign.png" id="edit_sign"/></button>
                </div>
                        ...
                        <form action="update_profile.php" method="POST" id="personal_form">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8"><input type="text" class="form-control" id="mobile"
                                                                         name="mobile" onblur='checkMobile()'
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8"><input type="text" class="form-control" id="f_name"
                                                                         name="f_name" onblur='checkF_name()'
                                                                         value="<?php echo $f_name ?>"></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                    ...
                                    <div class="form-group" id="spouse">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8"><input type="text" class="form-control" id="s_name"
                                                                         name="s_name" onblur='checkS_name()'
                                                                         value='<?php echo $s_name; ?>'></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                ...
                                <div class="modal-footer">
                                    <input type="submit" name="submit_personal" class="btn btn-info"
                                           value="Save Changes">
                                </div>
                            </div>
                        </form>
            ...
            <div class="box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"><span
                                id="age"><?php $diff = date_diff(date_create($dob), date_create(date("Y-m-d")));
                            echo $diff->format("%y years"); ?></span></div>
                </div>
    ...
    <div class="row">
        <div class="col-md-2">
            <button type="button" class="btn btn-success btn-block" data-toggle="collapse" data-target="#education">
                Education
            </button>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-9 collapse box" id="education">
            ...
            <div class="row">
                ...
                <div class="col-md-11"></div>
                <div class="col-md-1">
                    <button type="button" class="btn" data-toggle="modal" data-target="#edit_education"><img
                                src="img/edit_sign.png" id="edit_sign"/></button>
                </div>
                    ...
                    <div class="modal-dialog">
                        <form action="update_profile.php" method="post" id="education_form">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9"><input type="text" class="form-control" id="m_degree"
                                                                         name="m_degree"
                                                                         value='<?php echo $m_degree; ?>'></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9"><input type="text" class="form-control"
                                                                         id="m_institute" name="m_institute"
                                                                         value='<?php echo $m_institute; ?>'></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-3"><label>Passing Year</label></div>
                                            <div class="col-md-3"><input type="text" class="form-control" id="m_year"
                                                                         name="m_year" onblur="checkMYear()"
                                                                         value='<?php echo $m_year; ?>'></div>
                                            <div class="col-md-3 text-right"><label>CGPA</label></div>
                                            <div class="col-md-3"><input type="text" class="form-control" id="m_cgpa"
                                                                         name="m_cgpa" onblur="checkMCGPA()"
                                                                         value='<?php echo $m_cgpa; ?>'></div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9"><input type="text" class="form-control" id="b_degree"
                                                                         name="b_degree"
                                                                         value='<?php echo $b_degree; ?>'></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-3"><label>Institue Name</label></div>
                                            <div class="col-md-9"><input type="text" class="form-control"
                                                                         id="b_institute" name="b_institute"
                                                                         value='<?php echo $b_institute; ?>'></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-3"><label>Passing Year</label></div>
                                            <div class="col-md-3"><input type="text" class="form-control" id="b_year"
                                                                         name="b_year" onblur="checkBYear()"
                                                                         value='<?php echo $b_year; ?>'></div>
                                            <div class="col-md-3 text-right"><label>CGPA</label></div>
                                            <div class="col-md-3"><input type="text" class="form-control" id="b_cgpa"
                                                                         name="b_cgpa" onblur="checkBCGPA()"
                                                                         value='<?php echo $b_cgpa; ?>'></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3"></div>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="submit_education" class="btn btn-info">Save Changes
                                    </button>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-md-2">
            <button type="button" class="btn btn-warning btn-block" data-toggle="collapse" data-target="#join_details">
                Joining Details
            </button>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-9 collapse box" id="join_details">
            <div class="row">
                <div class="col-md-11"></div>
                <div class="col-md-1">
                    <button type="button" class="btn" data-toggle="modal" data-target="#edit_join_details"><img
                                src="img/edit_sign.png" id="edit_sign"/></button>
                </div>
                    ...
                    <div class="modal-dialog">
                        <form action="update_profile.php" method="post">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="submit_joining" class="btn btn-info">Save Changes
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <button type="button" class="btn btn-primary btn-block" data-toggle="collapse" data-target="#pay_details">
                Payment Details
            </button>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-9 collapse box" id="pay_details">
            <div class="row">
                <div class="col-md-11"></div>
                <div class="col-md-1">
                    <button type="button" class="btn" data-toggle="modal" data-target="#edit_pay_details"><img
                                src="img/edit_sign.png" id="edit_sign"/></button>
                </div>
                    ...
                    <div class="modal-dialog">
                        <form action="update_profile.php" method="post" id="payment_form">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"><input type="text" class="form-control" id="basic"
                                                                         name="basic" onblur="checkBasic()"
                                                                         value='<?php echo $basic; ?>'></div>
                                            <div class="col-md-3 text-right"><label>HRA</label></div>
                                            <div class="col-md-3"><input type="text" class="form-control" id="hra"
                                                                         name="hra" onblur="checkHRA()"
                                                                         value='<?php echo $hra; ?>'></div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"><input type="text" class="form-control"
                                                                         ...
                                                                         onblur="checkConveyance()"
                                                                         value='<?php echo $conveyance; ?>'></div>
                                            <div class="col-md-3 text-right"><label>Medical&nbsp;Allowance</label></div>
                                            <div class="col-md-3"><input type="text" class="form-control" id="medical"
                                                                         name="medical" onblur="checkMedical()"
                                                                         value='<?php echo $medical; ?>'></div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"><input type="text" class="form-control" id="special"
                                                                         name="special" onblur="checkSpecial()"
                                                                         value='<?php echo $special; ?>'></div>
                                            <div class="col-md-3 text-right"><label>Provident&nbsp;Fund</label></div>
                                            <div class="col-md-3"><input type="text" class="form-control" id="provident"
                                                                         name="provident" onblur="checkProvident()"
                                                                         value='<?php echo $provident; ?>'></div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="submit_payment" class="btn btn-info">Save Changes
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <div class="row">
        <div class="col-md-2">
            <button type="button" class="btn btn-danger btn-block" data-toggle="collapse" data-target="#bank_details">
                Bank Details
            </button>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-9 collapse box" id="bank_details">
            <div class="row">
                <div class="col-md-11"></div>
                <div class="col-md-1">
                    <button type="button" class="btn" data-toggle="modal" data-target="#edit_bank_details"><img
                                src="img/edit_sign.png" id="edit_sign"/></button>
                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7"><input type="text" class="form-control" id="bankname"
                                                                         name="bankname" onblur="checkBankName()"
                                                                         value='<?php echo $bankname; ?>'></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3"></div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7"><input type="text" class="form-control" id="account"
                                                                         name="account" onblur="checkAccount()"
                                                                         value='<?php echo $account; ?>'></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3"></div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7"><input type="text" class="form-control" id="pan"
                                                                         name="pan" onblur="checkPAN()"
                                                                         value='<?php echo $pan; ?>'></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3"></div>
    ...
    <div class="row">
        <div class="col-md-2">
            <button type="button" class="btn btn-primary btn-block" data-toggle="collapse" data-target="#address">
                Address
            </button>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-9 collapse box" id="address">
            <div class="row">
                <div class="col-md-11"></div>
                <div class="col-md-1">
                    <button type="button" class="btn" data-toggle="modal" data-target="#edit_address"><img
                                src="img/edit_sign.png" id="edit_sign"/></button>
                </div>
                    ...
                    <div class="modal-dialog">
                        <form action="update_profile.php" method="post">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7"><textarea class="form-control" id="	c_address"
                                                                            name="c_address"><?php echo $c_address; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7"><textarea class="form-control" id="p_address"
                                                                            name="p_address"><?php echo $p_address; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="submit_address" class="btn btn-info">Save Changes
                                    </button>
                                </div>
                            </div>
                        </form>
